...
#SBATCH --mem=32G
#SBATCH -o /homedtic/malenya/Simulations/Atlas/outs/%x-%j.out
#SBATCH -e /homedtic/malenya/Simulations/Atlas/outs/%x-%j.err
...
export RESULTS_DIR="/homedtic/malenya/Simulations/Atlas/Results"						# Path to results folder (Global folder of the whole study. Subfolders with "NAME" will be created inside))
export MAP="/homedtic/malenya/Simulations/Atlas/Maps/STA2537_MAP.txt"						# Path to txt file with "distance maps" information. 
export NAME="STA25.MAP2537."$TEST															    # Name of folder with results, inside the Results folder
...
g++ -Ofast -fopenmp growth.cpp vema.cpp eig3.cpp -o $TEST".growthmap"
